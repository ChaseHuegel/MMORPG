...
public abstract class Command
{
    ...
    protected virtual Task<CommandCompletion> InvokeAsync(ReadOnlyQueue<string> args)
    {
        return Task.FromResult(CommandCompletion.Failure);
    }
    ...
    public async Task<bool> TryInvokeAsync(ReadOnlyQueue<string> args)
    {
        ...
        if (await InvokeAsync(args) == CommandCompletion.Success)
            return true;
